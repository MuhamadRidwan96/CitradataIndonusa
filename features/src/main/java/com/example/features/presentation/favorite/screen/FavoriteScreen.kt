...
import com.example.features.presentation.favorite.FavoriteViewModel
                ...
                LazyColumn(
                    ...
                    itemsIndexed(
                        ...
                        ProjectCard(
                            ...
                            onToggleFavorite = {
                                viewModel.action(
                                    FavoriteUiAction.RemoveFavorite(
                                        projectId = favorite.idProject
                                    )
                                )
                            }
                        )
